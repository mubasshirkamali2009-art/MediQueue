...
<div>
    ...
    <div className="min-h-screen bg-[#0b1623] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-3xl">
        ...
        {/* Header */}
        <div className="mb-8">
          <p className="text-[#5ba3d9] text-sm font-semibold uppercase tracking-widest mb-2">MediQueue</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full bg-[#5ba3d9] hover:bg-[#4a8ec4] active:scale-[0.98] text-[#0b1623] font-semibold text-sm py-4 rounded-2xl transition-all tracking-wide uppercase"
          >
            {submitted ? "✓ Profile Submitted!" : "Submit Tutor Profile"}
          </button>
