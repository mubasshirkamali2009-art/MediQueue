      ...
      <div className="w-full max-w-md bg-white border border-gray-100 rounded-2xl px-8 py-10 shadow-sm">
        ...
        <form onSubmit={onSubmit} noValidate>
          ...
          <p className="text-sm text-gray-500 mb-7">
            Join thousands of teams already using Meddique.
          </p>
          ...
          {/* First Name */}
          <div className="mb-4">
            <label htmlFor="first-name" className="block text-[13px] font-medium text-gray-500 mb-1.5">
              First name
            </label>
            <input
              id="first-name"
          ...
          {/* Profile Image URL */}
          <div className="mb-4">
            <label htmlFor="img-url" className="block text-[13px] font-medium text-gray-500 mb-1.5">
              Profile image URL
            </label>
            <div className="relative">
              <input
